...
*/
select first_name from employeetable where LAST_NAME like "%";
select curdate();		-- q38

select DEPARTMENT,sum(employeetable.SALARY) + sum(incentive_amount)  as Total_Salary from incentives inner join employeetable ;
